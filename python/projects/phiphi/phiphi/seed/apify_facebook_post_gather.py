...
TEST_APIFY_FACEBOOK_POST_GATHER_CREATE = schemas.ApifyFacebookPostsGatherCreate(
...
TEST_APIFY_FACEBOOK_POST_GATHER_CREATE_2 = schemas.ApifyFacebookPostsGatherCreate(
...
TEST_APIFY_FACEBOOK_POST_GATHER_CREATE_3 = schemas.ApifyFacebookPostsGatherCreate(
