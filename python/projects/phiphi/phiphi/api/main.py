...
from phiphi.api.projects.gathers.apify_facebook_posts import routes as apify_facebook_routes
...
app.include_router(apify_facebook_routes.router, tags=["Apify Facebook"])
