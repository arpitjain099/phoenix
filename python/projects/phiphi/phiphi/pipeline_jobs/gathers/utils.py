...
def load_sample_raw_data(
    ...
    elif child_type_name == gather_schemas.ChildTypeName.apify_facebook_search_posts:
        relative_path = "apify_sample_data/facebook_search_posts.json"
    elif child_type_name == gather_schemas.ChildTypeName.apify_tiktok_accounts_posts:
    ...
    elif child_type_name == gather_schemas.ChildTypeName.apify_tiktok_searches_posts:
        relative_path = "apify_sample_data/tiktok_searches_posts.json"
