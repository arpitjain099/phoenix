...
import { useCreate, useOne, useParsed, useTranslate } from "@refinedev/core";
import { Create, Edit, TextField, useForm } from "@refinedev/mantine";
...
export default function ApifyFacebookPostDuplicate(): JSX.Element {
	...
	useEffect(() => {
		...
		setFieldValue("only_posts_older_than", projectsData?.only_posts_older_than);
		setFieldValue("only_posts_newer_than", projectsData?.only_posts_newer_than);
